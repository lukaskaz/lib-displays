...
int main(int argc, char** argv)
{
    try
    {
        ...
        if (argc > 4)
        {
            ...
            using namespace display::sevseg::m74hc595::multi::bicolor;
            auto color = (colortype)atoi(argv[4]);
            auto iface = display::Factory::create<Display, config_t, param_t>(
                dev, {commontype::anode, color, 3ms, dispsize, logif});
        ...
        else if (argc > 2)
        {
            ...
            auto iface = display::Factory::create<Display, config_t, param_t>(
                dev,
                {commontype::anode, colortype::first, 10us, dispsize, logif});
